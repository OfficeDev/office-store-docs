...
description: After you create a Partner Center account, manage your account and offers using the Partner Center dashboard.
...
If you have not already done so, you (or your organization's administrator) should access the [account settings](https://partner.microsoft.com/dashboard/account/management) for your Partner Center account and:
...
This section shows your **Publisher display name**, **Seller contact info** (the contact name, email, phone number, and address for the company seller), and the **Company approver** (the name, email, and phone number of the individual with authority to approve decisions for the company).

### Financial details

This section is for your financial information if you publish apps or services that require payment.

If you only plan to list free offers, you don't need to set up a payout account or fill out any tax forms. If you change your mind later, and decide you do want to sell through Microsoft, set up your payout account and fill out tax forms at that time.

#### Payout account

A payout account is the bank account where your sales proceeds are sent. This bank account must be in the same country where you registered your Partner Center account.
...
2. When prompted, sign in with your Microsoft account. This account cannot already be associated with another Partner Center account.
...
Now that your Microsoft account is associated, add a payout account:
...
To establish your tax status, specify your country of residence and citizenship and complete the appropriate tax forms associated with your country/region.

Regardless of your country of residence or citizenship, fill out United States tax forms to sell any offers through Microsoft. Partners who satisfy certain United States residency requirements must fill out an IRS W-9 form. Other partners outside the United States must fill out an IRS W-8 form. Fill out these forms online as you complete your tax profile.
...
Complete and submit your tax forms electronically in Partner Center; in most cases, you don't need to print and mail any forms.
...
If you are outside the United States, you may be able to take advantage of tax treaty benefits. These benefits vary from country to country, and may allow you to reduce the amount of taxes that Microsoft withholds. Claim tax treaty benefits by completing Part II of the W-8BEN form. We recommend that you communicate with the appropriate resources in your country or region to determine whether these benefits apply to you.

#### Payout hold status

By default, Microsoft sends payments on a monthly basis. However, you have the option to put your payouts on hold, which will prevent sending payments to your account. If you do so, we’ll continue to record any revenue that you earn and provide the details in your **Payout summary**, but won't send any payments until you remove the hold.

To place your payments on hold, go to **Account settings**. Under **Financial details**, in the **Payout hold status** section, toggle the slider **On**. You may change your payout hold status at any time, but it may affect the next monthly payout. For example, if you want to hold April’s payout, make sure to set your payout hold status to **On** before the end of March.

Payments will remain on hold until you toggle the slider **Off**. When you do so, you’ll be included during the next monthly payout cycle (provided any applicable payment thresholds have been met). For example, if you’ve had your payouts on hold, but would like to have a payout generated in June, toggle the payout hold status **Off** before the end of May.
...
In the **Account Settings** > **Users** section, use Azure AD to manage the users, groups, and Azure AD applications that have access to your Partner Center account. This requires that you be signed in with your work account (the associated Azure AD tenant). To manage users within a different work account/tenant, sign out and then sign back in as a user with **Manager** permissions on that work account/tenant.

All Partner Center users (including groups and Azure AD applications) must have an active work account in an [Azure AD tenant](#manage-tenants) that is associated with your Partner Center account.
...
1. On the **Account settings** page, on the **Users** tab, select **+ Add user**.
1. Select one or more users from the list that appears. Use the search box to search for specific users.
...
1. On the **Account settings** page, on the **Users** tab, select **+ Add user**, then **Invite users by email**.
...
1. On the **Account settings** page, on the **Users** tab, select **Add groups**.
2. Select one or more groups from the list that appears. Use the search box to search for specific groups.
...
5. Select user(s) for the new group from the list that appears. Use the search box to search for specific users.
...
To grant Partner Center access to a new Azure AD application account, create one in the **Users** section. This will create a new account in your company work account (Azure AD tenant), not just in your Partner Center account. If you are primarily using this Azure AD application for Partner Center authentication, and don't need users to access it directly, enter any valid address for the **Reply URL** and **App ID URI**, as long as those values are not used by any other Azure AD application in your directory.
...
After you add or create an Azure AD application, return to the **Users** section and select the application name to review settings for the application, including the Tenant ID, Client ID, Reply URL, and App ID URI.
...
If your Azure AD application reads and writes data in Microsoft Azure AD, it will need a key. Create or remove keys for an Azure AD application by editing its information in Partner Center.

1. On the **Account settings** page, on the **Users** tab, select the name of the Azure AD application. You'll see all of the active keys for the Azure AD application, including the date on which the key was created and when it will expire.
...
You may set up multiple tenants to use with Partner Center. Any user with the **Manager** role in the Partner Center account will have the option to add and remove Azure AD tenants from the account.  

### Add an existing tenant

To associate another Azure AD tenant with your Partner Center account:

1. On the **Account settings** page, on the **Tenants** page, select **Associate another Azure AD tenant**.
...
1. On the **Account settings** page, on the **Tenants** page, select **Create a new Azure AD tenant**.
...
On the **Account settings** page, the **Agreements** page lists the publishing agreements you've authorized. These agreements are listed according to name and version number, including the date it was accepted and the name of the user that accepted the agreement.
