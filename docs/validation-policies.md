...
|14.20| Teams apps must use persistent/silent authentication in a capability. We recommend using persistent authentication across capabilities. For details about silent authentication, see [Silent authentication](https://docs.microsoft.com/microsoftteams/platform/tabs/how-to/authentication/auth-silent-aad).
